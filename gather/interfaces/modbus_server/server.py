            ...
            if unit_block.get('unit') == slave_unit:
                ...
                for reg in data:
                    if reg.get('addr') == addr:
                        ...
                        raise ModbusExchangeServerException(f'no source {addr=} at server corresponding addr map')
...
class ChannelsRequestHandler(ModbusServerRequestHandler):
    ...
    def connection_made(self, transport):
        ...
        logger.log('LOGIN', f'Client connection made from {transport.get_extra_info("peername")}')
